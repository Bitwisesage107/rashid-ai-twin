...
EXAMPLES = [
    "Tell me about Rashid's biggest AI project.",
    "Why did Rashid choose AI engineering?",
    "What technologies has Rashid used?",
    "What kind of roles is Rashid looking for?",
    "What are Rashid's future learning goals?",
]
...
.message-row .message p:first-child,
.message-row .message-bubble p:first-child,
.message-row .bubble p:first-child,
.message-row .prose p:first-child { 
